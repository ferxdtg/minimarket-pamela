...
export default function Hero() {
  ...
  // 🚀 ESTADOS DINÁMICOS DESDE FIREBASE (CMS)
  ...
  // 🚀 ESCUCHAR EN TIEMPO REAL LA CONFIGURACIÓN DEL PANEL
  useEffect(() => {
  ...
  return (
    <section className="relative w-full bg-[#F8F9FA] overflow-hidden pt-20 pb-16 md:pt-28 md:pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid md:grid-cols-[1.1fr_0.9fr] lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-12 items-center">
        ...
        {/* TARJETA FLOTANTE DERECHA DINÁMICA */}
        <div className="hidden md:flex justify-end relative perspective-1000 w-full">
          <div 
            className="relative w-full max-w-[340px] lg:max-w-sm bg-white/70 backdrop-blur-2xl border border-white p-8 rounded-[3rem] shadow-[0_20px_60px_rgba(0,0,0,0.05)] transform rotate-2 hover:rotate-0 hover:-translate-y-2 transition-all duration-500 cursor-pointer group ml-auto"
            onClick={() => handleAction("ofertas")}
          >
            {/* BADGE DINÁMICO */}
            ...
            {/* IMAGEN DE LA CANASTA O EMOJI SI NO HAY FOTO */}
            <div className="mb-5 flex items-center justify-center h-28">
              {content.promoCardImage ? (
                ...
                <div className="text-7xl group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-500 drop-shadow-sm">
                  🛍️
                </div>
              )}
            </div>
