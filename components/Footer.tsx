...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-slate-200 text-slate-600 pb-20 md:pb-12 pt-12 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-3">Accesos rápidos</h4>
            <ul className="space-y-2 text-sm font-bold">
              <li>
                <Link href="/mis-pamelas" className="text-amber-600 hover:text-amber-700 transition-colors flex items-center gap-1.5">
                  🪙 Mis Pamela Coins
                </Link>
              </li>
              <li>
                <Link href="/seguimiento" className="text-slate-600 hover:text-red-600 transition-colors flex items-center gap-1.5">
                  🛵 Rastrear Pedido
                </Link>
              </li>
              <li>
                <a href="#productos-section" className="text-slate-600 hover:text-red-600 transition-colors flex items-center gap-1.5">
                  🛍️ Catálogo
                </a>
              </li>
            </ul>
          ...
          {/* Columna 3: Contacto */}
          <div>
            <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-3">Contáctanos</h4>
            <ul className="space-y-2 text-sm text-slate-500">
              ...
              <li className="flex items-center gap-2">
                <span>🕐</span>
                <span>Lun–Dom: {settings.openTime} – {settings.closeTime}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="border-t border-slate-100 pt-6 text-xs text-slate-400 font-medium text-center">
